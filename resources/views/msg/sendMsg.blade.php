            ...
            <div class="sparkline8-graph dashone-comment messages-scrollbar dashtwo-messages">
                ...
                <center class="row">
                    <div class="totalPane">
                        ...
                        <div class="col-xs-12">
                            <p>متن پیام مورد نظر</p>
                            <textarea style="width: 80%; height: 200px" id="msgText" maxlength="1000" placeholder="حداکثر 1000 کاراکتر"></textarea>
                        </div>
        ...
        function sendQuery() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if(response == "ok")
                        document.location.href = '{{route('msgs')}}';
                    else if(response == "nok2")
                        alert('لطفا یکی از روش های ارسال را انتخاب فرمایید');
                    else if(response == "nok3")
                        alert('لطفا متن پیام خود را وارد فرمایید');
                    else {
