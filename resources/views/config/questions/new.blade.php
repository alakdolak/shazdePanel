...
@section('content')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="ansType" id="ansType" onchange="changeAnsType(this.value)">
                                ...
                                <option value="multi">4 گزینه ای</option>
                                <option value="rate">درجه ای</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div id="questionAnsDiv" class="row" style="display: none;">
                ...
                <div class="row" style="padding: 20px">
                    <div class="form-group">
                        ...
                        <select class="ui fluid search dropdown" multiple="" name="kindPlaceIdInput" id="kindPlaceIdInput">
                            <option value="0">همه مکان ها</option>
    ...
    <form id="newQuestionForm" action="{{route('questions.store')}}" method="post">
        @csrf
