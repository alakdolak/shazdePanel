        ...
        <div class="sparkline8-list shadow-reset mg-tb-30">
            <div class="sparkline8-hd">
                <div class="main-sparkline8-hd" style="display: flex; justify-content: space-between;">
                    <h1>سبک های سفر</h1>
                    <button class="btn btn-success" data-toggle="modal" data-target="#newModal">سبک سفر جدید</button>
                </div>
            </div>
    ...
    <div class="modal fade" id="newModal">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="{{route('tripStyle.store')}}" method="post">
                @csrf
                <!-- Modal body -->
    ...
    <div class="modal fade" id="editModal">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="{{route('tripStyle.doEdit')}}" method="post">
                    @csrf
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{route('tripStyle.delete')}}" method="post">
                    @csrf
        ...
        function editModal(_id){
            ...
            for(i = 0; i < places.length; i++){
                if(places[i]['id'] == _id){
                    ...
                    document.getElementById('editName').value = places[i]['name'];
                }
            }
        ...
        function deleteModal(_id){
            for(i = 0; i < places.length; i++){
                if(places[i]['id'] == _id){
                    ...
                    document.getElementById('deleteName').innerText = places[i]['name'];
                }
            }
