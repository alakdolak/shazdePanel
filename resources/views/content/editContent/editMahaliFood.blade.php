                    ...
                    <div class="sparkline13-list shadow-reset">
                        ...
                        <div class="sparkline13-graph">
                            <div class="container-fluid">
                                ...
                                <hr>
                                <form id="form" action="{{route('storeMahaliFood')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 f_r">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" id="name" placeholder="نام غذای محلی" value="{{$food->name}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 f_r">
                                            <div class="form-group" style="position: relative">
                                                ...
                                                <input type="text" class="form-control" name="city" id="city" value="{{$food->city}}" onkeyup="searchCity(this.value)">
                                                <input type="hidden" name="cityId" id="cityId" value="{{$food->cityId}}">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class=" f_r" style="margin-left: 10px;">
                                            ...
                                            <select id="kind" name="kind">
                                                ...
                                                <option value="3" {{$food->kind == 3? 'selected': ''}}>سالاد و پیش غذا</option>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class=" f_r" style="margin-left: 10px;">
                                            ...
                                            <label class="switch">
                                                <input type="radio" name="hotOrCold" id="hotOrCold" value="1" {{$food->hotOrCold == 1? 'checked' : ''}}>
                                        ...
                                        <div class="f_r">
                                            ...
                                            <label class="switch">
                                                <input type="radio" name="hotOrCold" id="hotOrCold" value="2" {{$food->hotOrCold == 2? 'checked' : ''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class=" f_r" style="margin-left: 10px;">
                                            ...
                                            <label class="switch">
                                                <input type="radio" name="veg" id="veg" value="1" {{$food->veg == 1? 'checked' : ''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                        <div class="f_r">
                                            ...
                                            <label class="switch">
                                                <input type="radio" name="veg" id="veg" value="0" {{$food->veg == 0? 'checked' : ''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                            ...
                                            @for($i = 0; $i < count($food->material); $i++)
                                                <div class="row" style="margin-top: 10px;">
                                                    <div class="col-md-3 f_r">
                                                        ...
                                                        <input type="text" name="matName[{{$i}}]" value="{{$food->material[$i][0]}}">
                                                    </div>
                                                    <div class="col-md-3 f_r">
                                                        <label>
                                                            مقدار مواد
                                                        </label>
                                                        <input type="text" name="matValue[{{$i}}]" value="{{$food->material[$i][1]}}">
                                                    </div>
                                                </div>
                                            @endfor
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="recipes" id="recipes" rows="10">{!! $food->recipes !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row center">
                                        <div class="col-md-6 f_r">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="keyword" id="keyword" onchange="setkeyWord(this.value)" value="{{$food->keyword}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 f_r">
                                            <div class="form-group">
                                                <label for="h1"> عنوان اصلی</label>
                                                <input type="text" class="form-control" name="h1" id="h1" onchange="changeH1(this.value)" value="{{$food->h1}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="meta" id="meta" rows="10" onkeyup="metaCheck(this.value)" maxlength="153" minlength="130">{!! $food->meta !!}</textarea>
                                                <div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" id="description" rows="10" onkeyup="descriptionCheck(this.value)">{!! $food->description !!}</textarea>
                                                <div>
                                        ...
                                        @for($i = 0; $i < count($food->tags); $i++)
                                            <div class="f_r" style="margin-left: 15px;">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="tag[]" id="tag{{$i+1}}" value="{{$food->tags[$i]}}" {{$i < 5 ? 'required' : ''}} onchange="checkTags()">
                                                </div>
                                            </div>
                                        @endfor
                                    </div>
