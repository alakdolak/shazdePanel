                        ...
                        <div class="sparkline13-graph">
                            <div class="container-fluid">
                                ...
                                <form id="form" action="{{route('storeSogatSanaie')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                    @csrf
                                    <input type="hidden" id="id" name="id" value="{{$sogat->id}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 f_r">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" id="name" placeholder="نام" value="{{$sogat->name}}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class=" f_r" style="margin-left: 10px;">
                                            ...
                                            <select id="kind" name="eatable" onchange="changeKind(this.value)">
                                                <option value="1" {{$sogat->eatable == 1 ? 'selected' : ''}}>خوراکی</option>
                                                <option value="0" {{$sogat->eatable == 0 ? 'selected' : ''}}>غیر خوراکی</option>
                                            </select>
                                        </div>
                                    </div>

                                    <div id="eatableDiv" style="display: {{$sogat->eatable == 1? 'block': 'none'}};">
                                        <hr>
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" name="torsh" id="torsh" value="on" {{$sogat->torsh == 1 ? 'checked' : ''}}>
                                            ...
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" name="shirin" id="shirin" value="on" {{$sogat->shirin == 1 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" name="talkh" id="talkh" value="on" {{$sogat->talkh == 1 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" name="malas" id="malas" value="on" {{$sogat->malas == 1 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" name="shor" id="shor" value="on" {{$sogat->shor == 1 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" name="tond" id="tond" value="on" {{$sogat->tond == 1 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                    ...
                                    <div id="notEatableDiv" style="display: {{$sogat->eatable == 0? 'block': 'none'}};">
                                        <hr>
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" name="jewelry" id="jewelry" value="on" {{$sogat->jewelry == 1 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" name="cloth" id="cloth" value="on" {{$sogat->cloth == 1 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" name="decorative" id="decorative" value="on"{{$sogat->decorative == 1 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" name="applied" id="applied" value="on" {{$sogat->applied == 1 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="radio" name="style" value="1" {{$sogat->style == 1 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="radio" name="style" value="2" {{$sogat->style == 2 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="radio" name="style" value="3" {{$sogat->style == 3 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="radio" name="fragile" value="1" {{$sogat->fragile == 1 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                            <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                                ...
                                                <label class="switch">
                                                    <input type="radio" name="fragile" value="0" {{$sogat->fragile == 0 ? 'checked' : ''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="material" id="material" placeholder="جنس ان را توضیح دهید" value="{{ $sogat->material }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                            ...
                                            <label class="switch">
                                                <input type="radio" name="size" value="1" {{$sogat->size == 1 ? 'checked' : ''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                        <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                            ...
                                            <label class="switch">
                                                <input type="radio" name="size" value="2"  {{$sogat->size == 2 ? 'checked' : ''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                        <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                            ...
                                            <label class="switch">
                                                <input type="radio" name="size" value="3" {{$sogat->size == 3 ? 'checked' : ''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                            ...
                                            <label class="switch">
                                                <input type="radio" name="weight" value="1" {{$sogat->weight == 1 ? 'checked' : ''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                        <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                            <span style="direction: rtl" class="myLabel">متوسط</span>
                                            <label class="switch">
                                                <input type="radio" name="weight" value="2" {{$sogat->weight == 2 ? 'checked' : ''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                        <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                            ...
                                            <label class="switch">
                                                <input type="radio" name="weight" value="3" {{$sogat->weight == 3 ? 'checked' : ''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                            ...
                                            <label class="switch">
                                                <input type="radio" name="price" value="1" {{$sogat->price == 1 ? 'checked' : ''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                        <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                            <span style="direction: rtl" class="myLabel">متوسط</span>
                                            <label class="switch">
                                                <input type="radio" name="price" value="2" {{$sogat->price == 2 ? 'checked' : ''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                        <div class="col-sm-2 f_r" style="border-left: solid gray;">
                                            ...
                                            <label class="switch">
                                                <input type="radio" name="price" value="3" {{$sogat->price == 3 ? 'checked' : ''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row center">
                                        <div class="col-md-6 f_r">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="keyword" id="keyword" onchange="setkeyWord(this.value)" value="{{$sogat->keyword}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 f_r">
                                            <div class="form-group">
                                                <label for="h1"> عنوان اصلی</label>
                                                <input type="text" class="form-control" name="h1" id="h1" onchange="changeH1(this.value)" value="{{$sogat->h1}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="meta" id="meta" rows="10" onkeyup="metaCheck(this.value)" maxlength="153" minlength="130">
                                                    {{$sogat->meta}}
                                                </textarea>
                                                <div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" id="description" rows="10" onkeyup="descriptionCheck(this.value)">{{ $sogat->description }}</textarea>
                                                <div>
                                    ...
                                    <div class="row">
                                        ...
                                        @for($i = 0; $i < count($sogat->tags); $i++)
                                            <div class="f_r" style="margin-left: 15px;">
                                                <div class="form-group">
                                                    <label for="name"> برچسب {{$i+1}} </label>
                                                    <input type="text" class="form-control" name="tag[]" id="tag{{$i+1}}" value="{{$sogat->tags[$i]}}" {{$i < 5 ? 'required' : ''}} onchange="checkTags()">
                                                </div>
                                            </div>
                                        @endfor
